...
<head>
    ...
    <link rel="icon" href="Imagens/automobile-with-wrench.png" type="image/png">
    <title> Mecanica Senai </title>
    <style>
    body {
...
<body>
    ...
    <div class="container-fluid" style="background-color: #ffffff;  text-align: center;">
        <img src="Imagens/banner mecanica.png" width= "100%" height"100" alt="Logo">
